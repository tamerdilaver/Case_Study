...
**
**  Purpose:
**  	Estimate all log-linear Realized GARCH(1,1) model parameters 
**
**  Date:
**    	10/01/2015
**
...
fVariance(const vTheta){
	decl dOmega, dBeta, dGamma, dXi, dPhi, dTau_1, dTau_2, dSigma2, vLogH;
...
/*
**  Function:	Estimate log-linear Realized GARCH(1,1) parameters
**
**  Input: 	 	vReturns, vRealMeasure, adOmega_hat, adBeta_hat, adGamma_hat, adXi_hat, adPhi_hat, adTau_1_hat, adTau_2_hat, adSigma2_u_hat, avVariance
**
...
//	decl vTemp_returns = vReturns_1;
	...
	savemat("vAE_CC_RK_LOG_LINEAR_RV_REALGARCH.xls", vSqrd_error);
...
**
**  Input: 		adMSE_OC [adress of MSE], vReturns_1 [return series], vBenchmark [Benchmark], dC [ratio]
**
**  Output: 	1
*/

fMSE(const adMSE_OC, const vReturns_1, const vRV, const vBenchmark, const dC){
...
**				MAIN PROGRAM
**
**  Purpose:	Estimate log-linear Realized GARCH(1,1) parameters			 
**
...
main()
{
	...
	//graphs
	SetDrawWindow("CS_EMP_3_log-linear_RealGARCH(1,1)");
	...
	decl dMSE_OC;
	fMSE(&dMSE_OC, vReturns_1, vRV, vBenchmark, dRATIO);
	print("\n dMSE_OC = ",dMSE_OC);
	
	decl dMSE_CC;
	fMSE(&dMSE_CC, vReturns_2, vRV, vBenchmark, 1);
	print("\n dMSE_CC = ",dMSE_CC);	
}
