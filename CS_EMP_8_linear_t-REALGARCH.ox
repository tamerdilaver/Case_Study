...
**
**  Purpose:
**  	Estimate all linear Realized t-GARCH(1,1) model parameters 
**
**  Date:
**    	10/01/2015
**
...
**
**  Input: 		adOmega, adBeta, adGamma, adXi, adPhi, adTau_1, adTau_2, adSigma2_u,  vTheta, adLambda_z, adLambda_u, vTheta
**				0		1	     2	      3	     4	    5	    6	     7		  
**  Output: 	1 
*/
...
/*
**  Function:	Calculates average value loglikelihood for linear realized t-GARCH(1,1) given parameter values
**
...
**  Input: 		vThetaStar
**
**  Output: 	vTheta [parameter values]
*/
...
/*
**  Function:	Estimate linear realized t-GARCH(1,1) parameters
**
...
fEstimateReal_t_GARCH(const vReturns, const vRealMeasure, const adOmega_hat, const adBeta_hat, const adGamma_hat, const adXi_hat, const adPhi_hat, const adTau_1_hat, const adTau_2_hat, const adSigma2_u_hat, const adLambda_z_hat, const adLambda_u_hat, const avVariance){
...
fMAE(const adMAE, const vReturns, const vRV, const vBenchmark, const dC){
	...
	savemat("vAE_OC_RV_LINEAR_RK_t-REALGARCH.xls", vSqrd_error);
...
**				MAIN PROGRAM
**
**  Purpose:	Estimate linear realized t-GARCH(1,1) parameters
**
...
main()
{
	...
	print("\nO-C");
	fEstimateReal_t_GARCH(vReturns_1, s_vX, &dOmega_hat, &dBeta_hat, &dGamma_hat, &dXi_hat, &dPhi_hat, &dTau_1_hat, &dTau_2_hat, &dSigma2_u_hat, &dLambda_z, &dLambda_u, &vVariance_1);

	print("\nC-C");
	fEstimateReal_t_GARCH(vReturns_2, s_vX, &dOmega_hat, &dBeta_hat, &dGamma_hat, &dXi_hat, &dPhi_hat, &dTau_1_hat, &dTau_2_hat, &dSigma2_u_hat, &dLambda_z, &dLambda_u, &vVariance_2);

	//graphs
	SetDrawWindow("CS_EMP_8_linear_t-RealGARCH(1,1)");
